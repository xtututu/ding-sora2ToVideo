...
var require$$0 = require('dingtalk-docs-cool-app');
...
function requireBuild () {
	...
	(function (exports) {
		...
		var _dingtalkDocsCoolApp = require$$0;
		...
		_dingtalkDocsCoolApp.fieldDecoratorKit.setDecorator({
		  ...
		  execute: function () {
		    var _execute = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(context, formItemParams) {
		      var videoMethod, videoPrompt, refImage, size, seconds, debugLog, createVideoUrl, requestBody, requestOptions, createTask, taskResp, videoDetailUrl, detailRequestOptions, pollingInterval, maxPollingTime, startTime, videoDetailResp, pollingComplete, getTaskDetail, _videoDetailResp, videoUrl, _t;
		      return _regenerator().w(function (_context) {
		        while (1) switch (_context.p = _context.n) {
		          ...
		          case 6:
		            ...
		            debugLog({
		              '轮询视频详情结果': videoDetailResp,
		              '已等待时间(秒)': Math.floor((Date.now() - startTime) / 1000)
		            });
		          ...
		          case 8:
		            // 未完成，等待5秒后继续轮询
		            debugLog("\u89C6\u9891\u72B6\u6001: ".concat(((_videoDetailResp = videoDetailResp) === null || _videoDetailResp === void 0 ? void 0 : _videoDetailResp.status) || 'unknown', ", \u7EE7\u7EED\u8F6E\u8BE2..."));
		            _context.n = 9;
		...
		exports["default"] = _dingtalkDocsCoolApp.fieldDecoratorKit; 
	} (build));
	return build;
}
